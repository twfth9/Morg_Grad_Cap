...
static inline void st7701_all_pixels_on_cmd(void)
{
  st7701_write_command(0x23);
}

static inline void st7701_all_pixels_off_cmd(void)
{
  st7701_write_command(0x22);
}

static inline void st7701_normal_display_on_cmd(void)
{
  st7701_write_command(0x13);
}
